...
class GcsRestoreTest extends BaseTest
{
    ...
    public function testProjectMetadataRestore(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('branches-metadata'),
        );
    ...
    public function testProjectEmptyMetadataRestore(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('branches-empty-metadata'),
        );
    ...
    public function testBucketsInBackup(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('buckets'),
        );
    ...
    public function testBucketMetadataRestore(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('metadata'),
        );
    ...
    public function testBucketDefaultBackendRestore(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('buckets-multiple-backends'),
        );
    ...
    public function testBucketWithoutPrefixRestore(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('bucket-without-prefix'),
        );
        $buckets = $restore->getBucketsInBackup();
    ...
    public function testBucketLinkRestore(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('buckets-linked-bucket'),
        );
        $buckets = $restore->getBucketsInBackup();
    ...
    public function testPermanentFilesRestore(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('permanent-files'),
        );
    ...
    public function testListConfigsInBackup(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('configurations'),
        );
    ...
    public function testRestoreTableWithHeader(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-with-header'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreTableWithoutHeader(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-without-header'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreTableFromMultipleSlices(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-multiple-slices'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreTableFromLargeAmountOfSlices(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls($sourceBucket),
        );
    ...
    public function testRestoreTableFromMultipleSlicesSharedPrefix(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-multiple-slices-shared-prefix'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreTablePrimaryKeys(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-properties'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreNativeDataTypesTable(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('native-data-types-table'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreAlias(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('alias'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
        $restore->restoreTableAliases();
    ...
    public function testRestoreAliasMetadata(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('alias-metadata'),
        );
    ...
    public function testRestoreFilteredAlias(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('alias-filtered'),
        );
        $restore->restoreBuckets();
        $restore->restoreTables();
        $restore->restoreTableAliases();
    ...
    public function testRestoreConfigurationsWithoutVersions(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('configurations-no-versions'),
        );
        $restore->restoreConfigs();
    ...
    public function testRestoreEmptyObjectInConfiguration(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('configuration-empty-object'),
        );
        $restore->restoreConfigs();
    ...
    public function testRestoreConfigurationRows(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('configuration-rows'),
        );
        $restore->restoreConfigs();
    ...
    public function testRestoreTableWithoutPrefix(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-without-prefix'),
        );
        $restore->restoreBuckets(true);
        $restore->restoreTables();
    ...
    public function testRestoreTableEmpty(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-empty'),
        );
        $restore->restoreBuckets();
        $restore->restoreTables();
    ...
    public function testRestoreTransformationMetadata(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('transformation-with-metadata'),
        );
        $restore->restoreConfigs();
    ...
    public function testRestoreAliasWithSourceTableDoesntExists(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('alias-source-table-doesnt-exists'),
            $testLogger,
        );
        $restore->restoreTableAliases();
    ...
    public function testRestoreTypedTableWithIntColumns(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('typed-table-with-int-columns'),
        );
    ...
    public function testRestoreTriggers(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('triggers'),
            $logger,
        );
...
JSON;
    ...
    public function testRestoreNotifications(): void
    {
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('notifications'),
        );
    ...
    public function testRestoreTableWithNullablePKs(): void
    {
        ...
        $restore = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('table-with-nullable-pk'),
            $logger,
        );
    ...
    {
        $backup = new GcsRestore(
            $this->sapiClient,
            $this->getListOfSignedUrls('buckets-with-tables'),
        );
